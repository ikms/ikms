 ...
 */
package org.agileframework.web.jetty;
...
public class JettyFactory {
	...
	public static Server createServerInSource(int port, String contextPath) {
		...
		WebAppContext webContext = new WebAppContext(ConstKey.DEFAULT_WEBAPP_PATH, contextPath);
	...
	public static void reloadContext(Server server) throws Exception {
		...
		classLoader.addClassPath(ConstKey.DEFAULT_WEBAPP_PATH+"/WEB-INF/classes");
