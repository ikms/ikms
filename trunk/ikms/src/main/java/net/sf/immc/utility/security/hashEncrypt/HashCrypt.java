/**
 * @(#)HashEncryptUtils.java
 * Copyright (C) 2003-2010 iocn.org All rights reserved
 */
package net.sf.immc.utility.security.hashEncrypt;
...
//        return SourceforgeJNI.SfCrypt_hashStringENC(this.swigCPtr, this, paramString);
...
//        SourceforgeJNI.SfCrypt_put_HavalRounds(this.swigCPtr, this, paramInt);
    }
    /**
     * Hash using HAVAL
     * There are two additional properties relevant to HAVAL:
...
//        SourceforgeJNI.SfCrypt_put_KeyLength(this.swigCPtr, this, paramInt);
    }
}
