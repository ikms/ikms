...
public class DateUtils {
	...
	//private static SimpleDateFormat format = new SimpleDateFormat(standard_format);
	//private static SimpleDateFormat simpleFormat = new SimpleDateFormat(standard_simple_format);
    ...
    public static Date getCurrentDateTimeDate(){
    	...
    	//方法二
    	//return formatTypeDate(currentTime, standard_format,Locale.SIMPLIFIED_CHINESE);
    	//方法三
